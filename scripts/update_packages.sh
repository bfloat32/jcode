...
LINUX_URL="https://github.com/bfloat32/jcode/releases/download/${VERSION}/jcode-linux-x86_64.tar.gz"
LINUX_ARM_URL="https://github.com/bfloat32/jcode/releases/download/${VERSION}/jcode-linux-aarch64.tar.gz"
MACOS_ARM_URL="https://github.com/bfloat32/jcode/releases/download/${VERSION}/jcode-macos-aarch64.tar.gz"
MACOS_INTEL_URL="https://github.com/bfloat32/jcode/releases/download/${VERSION}/jcode-macos-x86_64.tar.gz"
...
class Jcode < Formula
  ...
  homepage "https://github.com/bfloat32/jcode"
  version "$VERSION_NUM"
  license "MIT"
...
arch=('x86_64')
url="https://github.com/bfloat32/jcode"
license=('MIT')
provides=('jcode')
conflicts=('jcode')
source=("$LINUX_URL")
